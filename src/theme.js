...
export const shadowTokens = {
  xs: "0 1px 2px rgba(96, 12, 16, 0.16)",
  sm: "0 4px 12px rgba(96, 12, 16, 0.22)",
  md: "0 12px 24px rgba(127, 29, 29, 0.28)",
  lg: "0 18px 40px rgba(127, 29, 29, 0.32)",
};
...
const lightTheme = {
  ...
  text: "#3E0714",
  textMuted: "#8E1C3D",
  textMutedStrong: "#65102A",
  textInverse: "#FFF6F8",
  buttonText: "#320715",
  primary: colorRamps.primary[600],
  primaryContrast: "#FFF5F9",
  primarySoft: "rgba(207, 31, 95, 0.12)",
  ...
  border: "rgba(182, 34, 82, 0.28)",
  borderMuted: "rgba(182, 34, 82, 0.18)",
  borderStrong: "rgba(98, 11, 36, 0.42)",
  muted: "rgba(207, 31, 95, 0.08)",
  ring: "rgba(235, 58, 123, 0.42)",
  overlay: "rgba(84, 7, 34, 0.28)",
  scrim: "rgba(54, 4, 22, 0.22)",

  // Subtle crimson luminous wash for light mode
  backgroundImage: `radial-gradient(1240px 620px at 10% -12%, rgba(235, 58, 123, 0.14), transparent 70%), radial-gradient(940px 540px at 90% -4%, rgba(207, 31, 95, 0.1), transparent 76%)`,
};
...
const darkTheme = {
  ...
  text: "#FFE4EE",
  textMuted: "#F898B9",
  textMutedStrong: "#FFC1D6",
  textInverse: "#1A040C",
  buttonText: "#16020A",
  primary: colorRamps.primary[400],
  primaryContrast: "#16020A",
  primarySoft: "rgba(235, 58, 123, 0.18)",
  ...
  border: "rgba(235, 58, 123, 0.26)",
  borderMuted: "rgba(235, 58, 123, 0.16)",
  borderStrong: "rgba(235, 58, 123, 0.35)",
  muted: "rgba(235, 58, 123, 0.12)",
  ring: "rgba(235, 58, 123, 0.48)",
  overlay: "rgba(10, 1, 4, 0.72)",
  scrim: "rgba(10, 1, 4, 0.52)",

  // Deep crimson gradient for dark mode
  backgroundImage: `radial-gradient(1280px 600px at 12% -12%, rgba(235, 58, 123, 0.28), transparent 70%), radial-gradient(980px 560px at 90% -6%, rgba(207, 31, 95, 0.24), transparent 74%), linear-gradient(180deg, #120108 0%, #1C040C 44%, #2D0715 100%)`,
};
...
const componentButtonTokensLight = {
  primary: {
    ...
    shadow: "0 12px 32px rgba(167, 21, 73, 0.24)",
    hoverShadow: "0 16px 36px rgba(167, 21, 73, 0.3)",
    spinner: "rgba(255, 246, 250, 0.78)",
  },
  secondary: {
    bg: lightTheme.surfaceAlt,
    fg: lightTheme.text,
    border: "rgba(182, 34, 82, 0.35)",
    hoverBg: lightTheme.surface,
    hoverFg: lightTheme.primary,
    hoverBorder: "rgba(182, 34, 82, 0.55)",
    shadow: "0 6px 18px rgba(167, 21, 73, 0.14)",
    hoverShadow: "0 8px 22px rgba(167, 21, 73, 0.2)",
    spinner: "rgba(78, 11, 31, 0.55)",
  },
  subtle: {
    bg: lightTheme.primarySoft,
    fg: lightTheme.primary,
    border: "rgba(207, 31, 95, 0.38)",
    hoverBg: "rgba(167, 21, 73, 0.24)",
    hoverFg: lightTheme.primary,
    hoverBorder: "rgba(207, 31, 95, 0.58)",
    shadow: "none",
    hoverShadow: "none",
    spinner: "rgba(167, 21, 73, 0.75)",
  },
  ghost: {
    bg: "transparent",
    fg: lightTheme.text,
    border: "transparent",
    hoverBg: "rgba(167, 21, 73, 0.08)",
    hoverFg: lightTheme.primary,
    hoverBorder: "transparent",
    shadow: "none",
    hoverShadow: "none",
    spinner: "rgba(84, 7, 34, 0.5)",
  },
  destructive: {
    ...
    hoverBorder: "transparent",
    shadow: "0 12px 30px rgba(222, 46, 114, 0.22)",
    hoverShadow: "0 16px 34px rgba(222, 46, 114, 0.28)",
    spinner: "rgba(84, 7, 34, 0.6)",
  },
  tone: {
    neutral: {
      bg: lightTheme.surfaceMuted,
      fg: lightTheme.text,
      border: "rgba(182, 34, 82, 0.32)",
      hoverBg: lightTheme.surface,
      hoverFg: lightTheme.text,
      hoverBorder: "rgba(182, 34, 82, 0.45)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(182, 34, 82, 0.55)",
    },
    accent: {
      bg: "rgba(245, 74, 139, 0.16)",
      fg: lightTheme.accent,
      border: "rgba(245, 74, 139, 0.42)",
      hoverBg: "rgba(245, 74, 139, 0.22)",
      hoverFg: lightTheme.accent,
      hoverBorder: "rgba(245, 74, 139, 0.55)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(245, 74, 139, 0.82)",
    },
    info: {
...
const componentButtonTokensDark = {
  primary: {
    ...
    hoverBorder: "transparent",
    shadow: "0 12px 32px rgba(167, 21, 73, 0.32)",
    hoverShadow: "0 16px 36px rgba(167, 21, 73, 0.38)",
    spinner: "rgba(255, 237, 245, 0.7)",
  },
  secondary: {
    bg: darkTheme.surfaceAlt,
    fg: darkTheme.text,
    border: "rgba(235, 58, 123, 0.28)",
    hoverBg: darkTheme.surface,
    hoverFg: darkTheme.primary,
    hoverBorder: "rgba(235, 58, 123, 0.45)",
    shadow: "0 8px 24px rgba(12, 1, 5, 0.48)",
    hoverShadow: "0 10px 28px rgba(12, 1, 5, 0.55)",
    spinner: "rgba(235, 58, 123, 0.6)",
  },
  subtle: {
    bg: darkTheme.primarySoft,
    fg: darkTheme.primary,
    border: "rgba(235, 58, 123, 0.38)",
    hoverBg: "rgba(167, 21, 73, 0.2)",
    hoverFg: darkTheme.primary,
    hoverBorder: "rgba(235, 58, 123, 0.58)",
    shadow: "none",
    hoverShadow: "none",
    spinner: "rgba(235, 58, 123, 0.75)",
  },
  ghost: {
    bg: "transparent",
    fg: darkTheme.text,
    border: "transparent",
    hoverBg: "rgba(235, 58, 123, 0.12)",
    hoverFg: darkTheme.primary,
    hoverBorder: "transparent",
    shadow: "none",
    hoverShadow: "none",
  ...
  destructive: {
    ...
    hoverBorder: "transparent",
    shadow: "0 12px 30px rgba(222, 46, 114, 0.26)",
    hoverShadow: "0 16px 34px rgba(222, 46, 114, 0.34)",
  ...
  tone: {
    neutral: {
      ...
      fg: darkTheme.text,
      border: "rgba(235, 58, 123, 0.24)",
      hoverBg: darkTheme.surface,
      hoverFg: darkTheme.text,
      hoverBorder: "rgba(235, 58, 123, 0.32)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(235, 58, 123, 0.55)",
    },
    accent: {
      bg: "rgba(245, 74, 139, 0.2)",
      fg: darkTheme.accent,
      border: "rgba(245, 74, 139, 0.45)",
      hoverBg: "rgba(245, 74, 139, 0.26)",
      hoverFg: darkTheme.accent,
      hoverBorder: "rgba(245, 74, 139, 0.58)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(245, 74, 139, 0.8)",
    },
    info: {
    ...
    danger: {
      ...
      hoverBg: "rgba(248, 113, 113, 0.32)",
      hoverFg: darkTheme.danger,
      hoverBorder: "rgba(248, 113, 113, 0.65)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(248, 113, 113, 0.82)",
    },
  },
};
...
const componentBadgeTokensLight = {
  neutral: {
    ...
    outline: {
      bg: "transparent",
      border: "rgba(182, 34, 82, 0.48)",
      fg: lightTheme.textMuted,
    },
  },
  primary: {
    soft: {
      bg: "rgba(207, 31, 95, 0.12)",
      border: "rgba(207, 31, 95, 0.32)",
      fg: lightTheme.primary,
    },
    solid: {
      bg: lightTheme.primary,
    ...
    outline: {
      bg: "transparent",
      border: "rgba(207, 31, 95, 0.48)",
      fg: lightTheme.primary,
    },
  },
  accent: {
    soft: {
      bg: "rgba(222, 46, 114, 0.14)",
      border: "rgba(222, 46, 114, 0.34)",
      fg: lightTheme.accent,
    },
    solid: {
...
const componentBadgeTokensDark = {
  neutral: {
    soft: {
      bg: "rgba(235, 58, 123, 0.2)",
      border: "rgba(235, 58, 123, 0.32)",
    ...
    outline: {
      bg: "transparent",
      border: "rgba(235, 58, 123, 0.48)",
      fg: darkTheme.textMuted,
    },
  },
  primary: {
    soft: {
      bg: "rgba(235, 58, 123, 0.18)",
      border: "rgba(235, 58, 123, 0.35)",
      fg: darkTheme.primary,
    },
    solid: {
      bg: darkTheme.primary,
