...
export const shadowTokens = {
  xs: "0 1px 2px rgba(148, 12, 65, 0.18)",
  sm: "0 4px 12px rgba(148, 12, 65, 0.24)",
  md: "0 12px 24px rgba(191, 19, 86, 0.3)",
  lg: "0 18px 40px rgba(191, 19, 86, 0.36)",
};
...
const lightTheme = {
  ...
  text: "#360513",
  textMuted: "#891057",
  textMutedStrong: "#600C34",
  textInverse: "#FFF8FB",
  buttonText: "#260310",
  primary: colorRamps.primary[600],
  primaryContrast: "#FFF6F9",
  primarySoft: "rgba(191, 19, 86, 0.14)",
  ...
  border: "rgba(148, 12, 65, 0.28)",
  borderMuted: "rgba(148, 12, 65, 0.18)",
  borderStrong: "rgba(80, 7, 35, 0.42)",
  muted: "rgba(191, 19, 86, 0.1)",
  ring: "rgba(222, 47, 111, 0.42)",
  overlay: "rgba(68, 8, 32, 0.24)",
  scrim: "rgba(52, 5, 24, 0.2)",
...
const darkTheme = {
  ...
  text: "#FFDDEA",
  textMuted: "#F58BB2",
  textMutedStrong: "#FFB8D2",
  textInverse: "#17030D",
  buttonText: "#15020A",
  primary: colorRamps.primary[400],
  primaryContrast: "#15020A",
  primarySoft: "rgba(222, 47, 111, 0.2)",
  ...
  border: "rgba(222, 47, 111, 0.28)",
  borderMuted: "rgba(222, 47, 111, 0.18)",
  borderStrong: "rgba(222, 47, 111, 0.38)",
  muted: "rgba(222, 47, 111, 0.14)",
  ring: "rgba(222, 47, 111, 0.54)",
  overlay: "rgba(9, 0, 4, 0.72)",
  scrim: "rgba(9, 0, 4, 0.52)",
...
const componentButtonTokensLight = {
  primary: {
    ...
    shadow: "0 12px 32px rgba(148, 12, 65, 0.26)",
    hoverShadow: "0 16px 36px rgba(148, 12, 65, 0.32)",
    spinner: "rgba(255, 244, 250, 0.78)",
  },
  secondary: {
    bg: lightTheme.surfaceAlt,
    fg: lightTheme.text,
    border: "rgba(148, 12, 65, 0.35)",
    hoverBg: lightTheme.surface,
    hoverFg: lightTheme.primary,
    hoverBorder: "rgba(148, 12, 65, 0.55)",
    shadow: "0 6px 18px rgba(148, 12, 65, 0.16)",
    hoverShadow: "0 8px 22px rgba(148, 12, 65, 0.22)",
    spinner: "rgba(68, 8, 32, 0.55)",
  },
  subtle: {
    bg: lightTheme.primarySoft,
    fg: lightTheme.primary,
    border: "rgba(191, 19, 86, 0.38)",
    hoverBg: "rgba(148, 12, 65, 0.24)",
    hoverFg: lightTheme.primary,
    hoverBorder: "rgba(191, 19, 86, 0.58)",
    shadow: "none",
    hoverShadow: "none",
    spinner: "rgba(148, 12, 65, 0.75)",
  },
  ghost: {
    bg: "transparent",
    fg: lightTheme.text,
    border: "transparent",
    hoverBg: "rgba(148, 12, 65, 0.1)",
    hoverFg: lightTheme.primary,
    hoverBorder: "transparent",
    shadow: "none",
    hoverShadow: "none",
    spinner: "rgba(68, 8, 32, 0.5)",
  },
  destructive: {
    ...
    hoverBorder: "transparent",
    shadow: "0 12px 30px rgba(216, 43, 138, 0.24)",
    hoverShadow: "0 16px 34px rgba(216, 43, 138, 0.3)",
    spinner: "rgba(68, 8, 32, 0.6)",
  },
  tone: {
    neutral: {
      bg: lightTheme.surfaceMuted,
      fg: lightTheme.text,
      border: "rgba(148, 12, 65, 0.32)",
      hoverBg: lightTheme.surface,
      hoverFg: lightTheme.text,
      hoverBorder: "rgba(148, 12, 65, 0.45)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(148, 12, 65, 0.55)",
    },
    accent: {
      bg: "rgba(216, 43, 138, 0.16)",
      fg: lightTheme.accent,
      border: "rgba(216, 43, 138, 0.42)",
      hoverBg: "rgba(216, 43, 138, 0.22)",
      hoverFg: lightTheme.accent,
      hoverBorder: "rgba(216, 43, 138, 0.55)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(216, 43, 138, 0.82)",
    },
    info: {
...
const componentButtonTokensDark = {
  primary: {
    ...
    hoverBorder: "transparent",
    shadow: "0 12px 32px rgba(148, 12, 65, 0.34)",
    hoverShadow: "0 16px 36px rgba(148, 12, 65, 0.4)",
  ...
  secondary: {
    ...
    hoverBorder: "rgba(222, 47, 111, 0.45)",
    shadow: "0 8px 24px rgba(12, 1, 5, 0.48)",
    hoverShadow: "0 10px 28px rgba(12, 1, 5, 0.55)",
    spinner: "rgba(222, 47, 111, 0.6)",
  },
  subtle: {
    bg: darkTheme.primarySoft,
    fg: darkTheme.primary,
    border: "rgba(222, 47, 111, 0.38)",
    hoverBg: "rgba(148, 12, 65, 0.22)",
    hoverFg: darkTheme.primary,
    hoverBorder: "rgba(222, 47, 111, 0.58)",
    shadow: "none",
    hoverShadow: "none",
    spinner: "rgba(222, 47, 111, 0.75)",
  },
  ghost: {
    bg: "transparent",
    fg: darkTheme.text,
    border: "transparent",
    hoverBg: "rgba(222, 47, 111, 0.12)",
    hoverFg: darkTheme.primary,
    hoverBorder: "transparent",
    shadow: "none",
    hoverShadow: "none",
  ...
  destructive: {
    ...
    hoverBorder: "transparent",
    shadow: "0 12px 30px rgba(216, 43, 138, 0.28)",
    hoverShadow: "0 16px 34px rgba(216, 43, 138, 0.36)",
  ...
  tone: {
    neutral: {
      ...
      fg: darkTheme.text,
      border: "rgba(222, 47, 111, 0.24)",
      hoverBg: darkTheme.surface,
      hoverFg: darkTheme.text,
      hoverBorder: "rgba(222, 47, 111, 0.32)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(222, 47, 111, 0.55)",
    },
    accent: {
      bg: "rgba(216, 43, 138, 0.2)",
      fg: darkTheme.accent,
      border: "rgba(216, 43, 138, 0.45)",
      hoverBg: "rgba(216, 43, 138, 0.26)",
      hoverFg: darkTheme.accent,
      hoverBorder: "rgba(216, 43, 138, 0.58)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(216, 43, 138, 0.8)",
    },
    info: {
...
const componentBadgeTokensLight = {
  neutral: {
    ...
    outline: {
      bg: "transparent",
      border: "rgba(148, 12, 65, 0.48)",
      fg: lightTheme.textMuted,
    },
  },
  primary: {
    soft: {
      bg: "rgba(191, 19, 86, 0.12)",
      border: "rgba(191, 19, 86, 0.32)",
      fg: lightTheme.primary,
    },
    solid: {
      bg: lightTheme.primary,
    ...
    outline: {
      bg: "transparent",
      border: "rgba(191, 19, 86, 0.48)",
      fg: lightTheme.primary,
    },
  },
  accent: {
    soft: {
      bg: "rgba(216, 43, 138, 0.14)",
      border: "rgba(216, 43, 138, 0.34)",
      fg: lightTheme.accent,
    },
    solid: {
...
const componentBadgeTokensDark = {
  neutral: {
    soft: {
      bg: "rgba(222, 47, 111, 0.2)",
      border: "rgba(222, 47, 111, 0.32)",
  ...
  primary: {
    ...
    outline: {
      bg: "transparent",
      border: "rgba(222, 47, 111, 0.52)",
      fg: darkTheme.primary,
    },
  },
  accent: {
    soft: {
      bg: "rgba(216, 43, 138, 0.22)",
      border: "rgba(216, 43, 138, 0.42)",
      fg: darkTheme.accent,
    },
    solid: {
