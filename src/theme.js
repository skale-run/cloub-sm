...
const colorRamps = {
  ...
  neutral: {
    ...
    100: "#F1F5F9",
    200: "#E2E8F0",
    300: "#CBD5E1", // slight fix from F5 -> E1 (slate-300)
    400: "#94A3B8",
    500: "#64748B",
    600: "#475569",
    700: "#334155",
...
const lightTheme = {
  ...
  text: "#420507",
  textMuted: "#7F1D1D",
  textMutedStrong: "#591014",
  textInverse: "#FFF7F7",
  buttonText: "#2C0405",
  primary: colorRamps.primary[600],
  primaryContrast: "#FFF5F5",
  ...
  border: "rgba(200, 34, 34, 0.28)",
  borderMuted: "rgba(200, 34, 34, 0.18)",
  borderStrong: "rgba(108, 11, 16, 0.42)",
  muted: "rgba(127, 29, 29, 0.08)",
  ring: "rgba(239, 68, 68, 0.4)",
  overlay: "rgba(86, 8, 10, 0.32)",
  scrim: "rgba(68, 6, 8, 0.24)",

  // Subtle red luminous wash for light mode
  backgroundImage:
    "radial-gradient(1200px 600px at 10% -10%, rgba(239, 68, 68, 0.12), transparent 70%), radial-gradient(900px 500px at 90% 0%, rgba(220, 38, 38, 0.08), transparent 75%)",
};
...
const darkTheme = {
  ...
  text: "#FFEAEA",
  textMuted: "#FCA5A5",
  textMutedStrong: "#FED7D7",
  textInverse: "#1B0405",
  buttonText: "#160203",
  primary: colorRamps.primary[300],
  primaryContrast: "#160203",
  ...
  borderMuted: "rgba(248, 113, 113, 0.16)",
  borderStrong: "rgba(248, 113, 113, 0.32)",
  muted: "rgba(248, 113, 113, 0.12)",
  ring: "rgba(248, 113, 113, 0.45)",
  overlay: "rgba(16, 2, 3, 0.7)",
  scrim: "rgba(16, 2, 3, 0.52)",

  // Deep crimson gradient for dark mode
  backgroundImage:
    "radial-gradient(1200px 600px at 10% -10%, rgba(239, 68, 68, 0.2), transparent 70%), radial-gradient(900px 500px at 90% 0%, rgba(220, 38, 38, 0.16), transparent 75%), linear-gradient(180deg, rgb(19 2 3) 0%, rgb(28 4 6) 45%, rgb(36 6 8) 100%)",
};
...
const componentButtonTokensLight = {
  ...
  secondary: {
    ...
    fg: lightTheme.text,
    border: "rgba(200, 34, 34, 0.35)",
    hoverBg: lightTheme.surface,
    hoverFg: lightTheme.primary,
    hoverBorder: "rgba(200, 34, 34, 0.55)",
    shadow: "0 6px 18px rgba(200, 34, 34, 0.12)",
    hoverShadow: "0 8px 22px rgba(200, 34, 34, 0.18)",
    spinner: "rgba(66, 8, 10, 0.55)",
  },
  subtle: {
  ...
  destructive: {
    ...
    spinner: "rgba(66, 8, 10, 0.6)",
  },
  tone: {
    neutral: {
      bg: lightTheme.surfaceMuted,
      fg: lightTheme.text,
      border: "rgba(200, 34, 34, 0.32)",
      hoverBg: lightTheme.surface,
      hoverFg: lightTheme.text,
      hoverBorder: "rgba(200, 34, 34, 0.45)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(200, 34, 34, 0.55)",
    },
    accent: {
      bg: "rgba(255, 79, 79, 0.16)",
      fg: lightTheme.accent,
      border: "rgba(255, 79, 79, 0.42)",
      hoverBg: "rgba(255, 79, 79, 0.22)",
      hoverFg: lightTheme.accent,
      hoverBorder: "rgba(255, 79, 79, 0.55)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(255, 79, 79, 0.8)",
    },
    info: {
...
const componentButtonTokensDark = {
  ...
  secondary: {
    ...
    shadow: "0 8px 24px rgba(18, 4, 6, 0.45)",
    hoverShadow: "0 10px 28px rgba(18, 4, 6, 0.52)",
    spinner: "rgba(248, 113, 113, 0.6)",
  },
  subtle: {
  ...
  tone: {
    neutral: {
      ...
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(248, 113, 113, 0.55)",
    },
    accent: {
      bg: "rgba(255, 79, 79, 0.2)",
      fg: darkTheme.accent,
      border: "rgba(255, 79, 79, 0.45)",
      hoverBg: "rgba(255, 79, 79, 0.26)",
      hoverFg: darkTheme.accent,
      hoverBorder: "rgba(255, 79, 79, 0.58)",
      shadow: "none",
      hoverShadow: "none",
      spinner: "rgba(255, 79, 79, 0.8)",
    },
