  ...
  return (
    <section id="profile" className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-semibold text-red-50 sm:text-2xl">My athlete profile</h2>
          <p className="text-sm text-red-200/75">Keep your credentials current to unlock personalised drills and access.</p>
        </div>
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
        <RedSurface as="form" tone="muted" className="p-6 text-red-50" onSubmit={onSaveProfile}>
          <div className="grid gap-4 md:grid-cols-2">
            <label className="flex flex-col gap-2 text-sm">
              <span className="font-semibold text-red-50">Full name</span>
              <input
            ...
            <label className="flex flex-col gap-2 text-sm">
              <span className="font-semibold text-red-50">Role</span>
              <input
            ...
            <label className="flex flex-col gap-2 text-sm">
              <span className="font-semibold text-red-50">Squad / Tier</span>
              <input
            ...
            <label className="flex flex-col gap-2 text-sm">
              <span className="font-semibold text-red-50">Email</span>
              <input
                type="email"
            ...
            <label className="flex flex-col gap-2 text-sm">
              <span className="font-semibold text-red-50">Emergency contact</span>
              <input
            ...
            <label className="flex flex-col gap-2 text-sm">
              <span className="font-semibold text-red-50">Membership ID</span>
              <input
          ...
          {statusMessage && (
            <p className="mt-4 inline-flex rounded-2xl border border-red-400/30 bg-red-500/10 px-4 py-2 text-sm text-red-100">
              {statusMessage}
            </p>
          )}
        </RedSurface>
        ...
        <RedSurface tone="muted" className="flex flex-col gap-4 rounded-3xl p-6 text-red-50">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <h3 className="text-lg font-semibold text-red-50">Highlights & achievements</h3>
              <p className="text-sm text-red-200/75">Capture season wins to keep your motivation board updated.</p>
            </div>
