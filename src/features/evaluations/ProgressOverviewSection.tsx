      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
        <RedSurface tone="muted" className="rounded-3xl p-6 text-red-50">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {trendPoints.map((point) => (
              ...
              >
                <RedSurface
                  tone="glass"
                  className="flex h-36 w-full items-end justify-center rounded-2xl p-2"
                >
          ...
          <p className="mt-6 text-sm text-red-100/80">
            Target line marks desired progression for the quarter. Maintain
            current training density and continue sleep tracking.
          </p>
        </RedSurface>
