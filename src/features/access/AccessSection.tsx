  ...
  return (
    <section id="access" className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-semibold text-rose-50 sm:text-2xl">Club access QR</h2>
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
        <RedSurface tone="primary" className="flex flex-col gap-6 p-6 text-rose-50">
          <p className="text-sm text-rose-100/80">Show this code at the smart gate to enter the facility.</p>
          {savedProfile ? (
            <RedSurface
              tone="glass"
            ...
            >
              <img
                ...
                className="h-44 w-44 rounded-3xl border border-rose-400/40 bg-rose-950/40 p-3"
              />
              <div className="flex flex-col items-center gap-2 text-center sm:items-start sm:text-left">
                <p className="text-lg font-semibold text-rose-50">{savedProfile.fullName}</p>
                <p className="text-sm text-rose-100/75">ID · {savedProfile.membershipId}</p>
            ...
            >
              ...
              <p className="text-xs uppercase tracking-[0.3em] text-rose-200/70">Profile required</p>
            </RedSurface>
          )}
        </RedSurface>

        <RedSurface as="aside" tone="muted" className="p-6 text-rose-50">
          <h3 className="text-lg font-semibold text-rose-50">Access tips</h3>
