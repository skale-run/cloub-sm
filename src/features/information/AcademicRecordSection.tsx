...
const summaryInsights = [
  ...
  { key: "scholarshipEligibility", icon: Award },
  { key: "graduationPath", icon: GraduationCap },
] as const;

const creditDistribution = [
  { key: "coreSciences" },
  { key: "performanceLabs" },
  { key: "leadershipElectives" },
] as const;
...
const statusStyles: Record<ModuleStatus, string> = {
  ...
  labReportDue: "bg-amber-500/15 text-amber-200 border-amber-400/40",
};
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-between gap-2 text-xs uppercase tracking-[0.3em]">
                  ...
                  >
                    {t(
                      `information.academic.moduleStatuses.${module.status}`,
                    )}
                  </span>
              ...
              {upcomingEvaluations.map((evaluation) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-sm text-red-100/80">
                      {t(
                        "information.academic.upcomingEvaluations.dateLabel",
                        { date },
                      )}
                    </p>
                  </li>
