  ...
  translation: {
    ...
    app: {
      pageTitles: {
        ...
        profile: "ملف الممارس",
        guardianPortal: "بوابة الوالدين والأوصياء",
        access: "إدارة الوصول",
        overview: "نظرة عامة",
      },
      statusMessages: {
        ...
        saveError: "تعذّر تحديث الملف. تحقّق من الاتصال وحاول مرة أخرى.",
        deleteError: "تعذّر حذف الملف الآن. يرجى المحاولة مجددًا بعد قليل.",
      },
      defaults: {
    ...
    sidebar: {
      ...
      logout: {
        label: "تسجيل الخروج",
        description: "العودة إلى شاشة تسجيل الدخول لبوابة الرياضي.",
        ariaLabel: "تسجيل الخروج من بوابة الرياضي",
      },
    },
    calendar: {
      ...
      states: {
        loading: "جاري تحميل الجدول المحدّث...",
        loadFailed: "تعذّر تحديث الجدول. يتم عرض الأحداث المخزنة مؤقتًا.",
        noEventsFiltered:
      ...
      eventForm: {
        ...
        editDescription: "حدّث معلومات الجدول لهذا الحدث في التقويم.",
        fields: {
          title: "عنوان الحدث",
          start: "البدء",
          end: "الانتهاء",
    ...
    information: {
      ...
      guardianPortal: {
        badge: "وضع أولياء الأمور",
        title: "ابقَ على اطلاع مع لاعبك",
        description:
          "تابع نمط الحضور، وحافظ على الفوترة محدثة، واستعد للالتزامات القادمة في موجز واحد مبسّط.",
        summaryCards: {
          attendance: {
            label: "الحضور هذا الشهر",
            value: "12 / 14 جلسة",
            helper: "على المسار نحو هدف الحضور في الدوجان",
          },
          billing: {
            label: "الرصيد المستحق",
            value: "MAD 180",
            helper: "اشتراك الربيع · يستحق 25 أبريل",
          },
          events: {
            label: "الالتزامات القادمة",
            value: "حدثان قادمان",
            helper: "بطولة إقليمية ومنتدى أولياء الأمور",
          },
        },
        feed: {
          ...
          items: {
            attendance: {
              badge: "تحديث الحضور",
              title: "سلسلة خمس جلسات مستمرة",
              description:
                "سجّل جوردان الحضور في كل حصة دوجان هذا الأسبوع. ملاحظات الطاقة ما تزال مرتفعة.",
              timestamp: "تم التحديث قبل ساعتين",
              patternLabel: "آخر 7 جلسات",
              days: {
                mon: "الإثنين",
                tue: "الثلاثاء",
                wed: "الأربعاء",
              ...
              callout:
                "حافظوا على نافذة الاستشفاء النشط يوم الخميس لحماية السلسلة.",
            },
            billing: {
              badge: "حالة الفوترة",
              title: "الدفع التلقائي محدد في 25 أبريل",
              description:
                "سيتم سحب رسوم اشتراك الربيع تلقائيًا. لا يلزم أي إجراء إضافي.",
              timestamp: "تمت المزامنة هذا الصباح",
              balanceLabel: "المبلغ المستحق",
              balanceValue: "MAD 180 مستحق",
              balanceHelper: "فاتورة INV-2045 · تستحق 25 أبريل",
              autopayLabel: "الدفع التلقائي",
              autopayValue: "تشغيل 25 أبريل عند 09:00",
              autopayHelper: "Visa •••• 4298",
            },
            events: {
              badge: "الفعاليات القادمة",
              title: "التزامان الأسبوع القادم",
              description:
                "البطولة الإقليمية ومنتدى الأولياء موجودان في التقويم.",
              timestamp: "تم التحديث للتو",
              list: {
                regional: {
                  title: "بطولة السبارينغ الإقليمية",
                  date: "21 أبريل · الوصول 08:00",
                  helper: "يرجى تأكيد تسجيل السفر قبل الجمعة 18 أبريل.",
                },
                parentForum: {
                  title: "منتدى تنسيق الأولياء",
                  date: "24 أبريل · 19:00",
                  helper: "في الاستوديو عالي الأداء.",
                },
              },
            },
          },
        ...
        messaging: {
          heading: "الرسائل مع الطاقم التدريبي",
          helper: "قناة آمنة مع الماسترز للتحديثات السريعة.",
          messages: {
            masterLewis: {
              author: "الماستر أمارا لويس",
              role: "المدرب الرئيسي",
              body: "حافظ جوردان على انفجار ممتاز خلال سلّم البليومتريك اليوم. التركيز رائع.",
              timestamp: "أُرسلت 4:10 م",
            },
            guardian: {
              author: "أنت",
              role: "ولي أمر",
              body: "شكرًا! سنعزّز الترطيب الليلة قبل حصة الصباح.",
              timestamp: "أُرسلت 4:18 م",
            },
            masterLewisFollowUp: {
              author: "الماستر أمارا لويس",
              role: "المدرب الرئيسي",
              body: "ممتاز. سنرسل مقطعًا قصيرًا من معاينة السبارينغ فور تحميله.",
              timestamp: "أُرسلت 4:26 م",
            },
          },
          quickReplies: {
            transport: "تحديث وقت الالتقاط",
            billing: "استفسار عن الفاتورة",
            checkIn: "تأكيد وقت الوصول",
          },
          composer: {
            label: "اكتب رسالة",
            placeholder: "اكتب تحديثًا سريعًا أو سؤالًا…",
            cta: "إرسال",
          },
        },
      },
